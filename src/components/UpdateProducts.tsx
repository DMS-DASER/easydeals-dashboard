                        ...
                        <div className="space-y-4 w-full md:max-w-1/2 border-0 sm:border-r-slate-400 sm:border-r-2 p-2">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full p-1 border rounded-md h-24 2xl:h-48 dark:border-gray-300 dark:bg-gray-50 text-sm dark:text-gray-800 focus:border-purple-600"
                                />
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea
                                    ...
                                    onChange={handleInputChange}
                                    className="w-full p-1 border rounded-md h-16 2xl:h-32 dark:border-gray-300 dark:bg-gray-50 text-sm dark:text-gray-800 focus:border-purple-600"
                                />
                            </div>
